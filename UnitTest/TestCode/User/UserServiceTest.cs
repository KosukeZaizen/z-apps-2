...
namespace UnitTest.UserTest
{
    ...
    public class UserServiceTest
    {
        ...
        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv1()
        {
            Assert.AreEqual(0, UserService.GetMinimumExpForTheLevel(1));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv2()
        {
            Assert.AreEqual(100, UserService.GetMinimumExpForTheLevel(2));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv3()
        {
            Assert.AreEqual(210, UserService.GetMinimumExpForTheLevel(3));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv4()
        {
            Assert.AreEqual(331, UserService.GetMinimumExpForTheLevel(4));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv5()
        {
            Assert.AreEqual(465, UserService.GetMinimumExpForTheLevel(5));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv30()
        {
            Assert.AreEqual(14864, UserService.GetMinimumExpForTheLevel(30));
        }

        [TestMethod]
        public void GetMinimumExpForTheLevel_testLv50()
        {
            Assert.AreEqual(105719, UserService.GetMinimumExpForTheLevel(50));
        }
